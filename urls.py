...
urlpatterns = patterns("",
    ...
    url(r"^perfis/", include("perfis.urls")),
    url(r'^comments/', include('django.contrib.comments.urls')),
)
# Me
urlpatterns += patterns("",
    url(r"^cadastro/", include("cadastro.urls")),
    url(r"^chromeless/", direct_to_template, {"template": "home_chromeless.html",}, name="chromeless"),
    
    #url(r"^dev/$", direct_to_template, {
    #    "template": "homepage.html",
    #}, name="home"),
    url(r"^dev/", include("homepage.urls")),
    url(r"^dev/cadastro/", include("cadastro.urls")),
    url(r"^dev/about/", include("about.urls")),
    url(r"^dev/admin/", include(admin.site.urls)),
    url(r"^dev/account/", include("pinax.apps.account.urls")),
    url(r"^dev/perfis/", include("perfis.urls")),
    url(r"^dev/photos/", include("pinax.apps.photos.urls")),
    url(r"^dev/videos/", include("videos.urls")),
    #url(r"^dev/chromeless/", direct_to_template, {"template": "home_chromeless.html",}, name="chromeless"),
)
